...
const Sidebar = () => {
  ...
  return (
    <div className={`flex h-screen w-64 border border-white flex-col justify-between border-r ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-slate-400 text-gray-800'}`}>
      <div className="px-4 py-6">
        <div className="mb-8">
          <span className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Admin Panel</span>
        </div>
